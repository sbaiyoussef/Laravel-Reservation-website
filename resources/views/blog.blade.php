      ...
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
	          	...
	          	<div style="margin-bottom:40%" class="text" >
		            
		            <h2 id="msg">@if(Session::has('message'))          
                    {{Session::get('message')}} 
                  @endif</h2>
				      </div>
	          
          	<div class="text">
	            <p class="breadcrumbs mb-2"><span class="mr-2"><a href={{route('home')}}>Home</a></span> <span>Blog</span></p>
